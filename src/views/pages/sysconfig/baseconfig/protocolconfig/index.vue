            ...
            <el-row>
                <el-col :span="20">
                    <el-row :gutter="10">
                        ...
                        <el-col :span="4">
                            <el-form-item prop="name">
                                <el-select v-model="initParams.name" clearable placeholder="协议归属">
                                    <el-option
                        ...
                        <el-col :span="4">
                            <el-form-item prop="name">
                                <el-select v-model="initParams.name" clearable placeholder="协议类型">
                                    <el-option
                                    v-for="item in options"
                                    :key="item.value"
                                    :label="item.label"
    ...
    data() {
        return {
            ...
            tableColumns:[
                ...
                { prop: 'c', label: '传输协议',minWidth:100},
                { prop: 'd', label: '协议归属',minWidth:100},
                { prop: 'e', label: '协议类型',minWidth:100},
                { prop: 'f', label: '连接组件',minWidth:100},
                { prop: 'g', label: '服务组件',minWidth:100},
