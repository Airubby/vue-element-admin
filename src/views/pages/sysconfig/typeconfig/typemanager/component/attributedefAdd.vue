<template>
    <el-dialog title='静态属性' :visible.sync="dialogInfo.visible" width="1100px" v-dialogDrag :close-on-click-modal="false" :append-to-body="true">
                        ...
                        <el-row :gutter="10">
                            <el-col :span="6">
                                <el-form-item prop="name">
                                    <el-input placeholder="关键字" v-model.trim="leftParams.name" clearable></el-input>
                                </el-form-item>
                            </el-col>
                            <el-col :span="6">
                                <el-form-item prop="name">
                                    <el-select v-model="leftParams.name" placeholder="静态属性分组">
                                        <el-option
    ...
    data(){
        return{
            ...
            tableColumns:[
                ...
                { prop: 'c', label: '指标分组码',minWidth:100},
                { prop: 'd', label: '单位',minWidth:100},
                { prop: 'e', label: '枚举定义',minWidth:100},
            ],
        }
    },
	methods: {
