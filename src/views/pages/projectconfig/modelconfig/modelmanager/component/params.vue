                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item class="align-right">
                                ...
                                <el-button type="primary" plain @click="handleRemove">全部保存</el-button>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
                <el-table-pagination
                    ...
                    :columns="tableColumns1" ref="tableRef">  
                        <template v-slot:preview-handle="scope">
                            ...
                            <el-button type="text" @click="handleAddEdit(scope.row)">保存</el-button>
                    ...
                    <el-row>
                        <el-col :span="24">
                            <el-form-item class="align-right">
                                ...
                                <el-button type="primary" plain @click="handleRemove(null,'tableRefMore')">全部保存</el-button>
                            </el-form-item>
                        </el-col>
                    </el-row>
                </el-form>
                <el-table-pagination
                    ...
                    :columns="tableColumns2" ref="tableRefMore">  
                        ...
                        <template v-slot:preview-handle="scope">
                            ...
                            <el-button type="text" @click="handleAddEdit(scope.row,'handleInfoMore')">保存</el-button>
